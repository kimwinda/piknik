...
<a href="#" class="logo">
  ...
  <span class="logo-lg"><b>Piknik </b>YUK</span>
</a>
          ...
          <li>
            ...
            <ul class="menu">
              <li><!-- start message -->
                <a href="#">
                  <div class="pull-left">
                    <img src="{{url('AdminLTE/dist/img/user2-.jpg')}}" class="img-circle" alt="User Image">
                  </div>
                  <h4>
                    Support Team
...
<li class="dropdown user user-menu">
  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
    <img src="{{url('AdminLTE/dist/img/pk1.png')}}" class="user-image" alt="User Image">
    <span class="hidden-xs">Piknik YUK</span>
  </a>
  <ul class="dropdown-menu">
    <!-- User image -->
